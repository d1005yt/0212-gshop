<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="item in tradeInfo.userAddressList" :key="item.id" >
        <span class="username" :class="{selected:item===selectedAddress}" @click="selectedAddress=item">{{item.consignee}}</span>
        <p @click="selectedAddress=item">
      ...
      <div class="detail" v-for="trade in tradeInfo.detailArrayList" :key="trade.skuId">
        <h5>商品清单</h5>
        <ul class="list clearFix">
          <li>
            <img :src="trade.imgUrl" alt="" style="width:100px">
          </li>
          <li>
            <p>{{trade.skuName}}</p>
            <h4>7天无理由退货</h4>
    ...
    <div class="sub clearFix">
      <a herf="javascript:" class="subBtn" @click="submitOrder">提交订单</a>
    </div>
  </div>
</template>
   ...
   mounted(){
    ...
    watch:{
      'tradeInfo.userAddressList'(value){
        const defaultAddress=value.find(item=>item.isDefault==='1')
