  ...
  <div class="pay-main">
    <div class="pay-container">
      <div class="checkout-tit">
        <h4 class="tit-txt" v-if="payInfo.resultCode==='SUCCESS'">
          <span class="success-icon"></span>
          <span class="success-info" >订单提交成功，请您及时付款，以便尽快为您发货~~</span>
        </h4>
        <!-- <h4 class="tit-txt" v-else>
          <span class="success-icon"></span>
          <span class="success-info" >订单提交成功，请您及时付款，以便尽快为您发货~~</span>
        </h4> -->
        <div class="paymark">
      ...
      pay(){
        ...
        .then(url=>{
          ...
          this.$alert(`<img src="${url}"/>`,'请使用微信支付',{
            ...
            this.$API.reqOrderStatue(this.$route.query.orderId)
            .then(result=>{
              if(result.code!==200){
                this.$message({
                  type:'warning',
              ...
              //   })
              //   this.$router.push('/paysuccess')
              //   this.$store.dispatch('deleteCheckedItem')
              // }
              clearInterval(this.intervalId)
            }).catch(error=>{
              console.log(error)
